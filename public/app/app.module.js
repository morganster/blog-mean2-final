...
var appRoutes = [
    { path: 'post', component: post_component_1.PostComponent, canActivate: [login_guard_1.LoginGuard] },
    {
        path: 'posts',
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        providers: [login_guard_1.LoginGuard, login_service_1.LoginService],
